...
const SUITES = [
  ...
  { name: 'assistant-memory', file: 'assistant-memory.mjs', kind: 'plain' },
  ...
  { name: 'ui-contracts', file: 'ui-contracts.mjs', kind: 'plain' },
  ...
  { name: 'import', file: 'import.mjs', kind: 'plain' },
  { name: 'capture-device', file: 'capture-device.mjs', kind: 'plain' },
  { name: 'capture-watcher', file: 'capture-watcher.mjs', kind: 'plain' },
  ...
  { name: 'pattern-discovery', file: 'pattern-discovery.mjs', kind: 'plain' },
  { name: 'pattern-discovery-trust', file: 'pattern-discovery-trust.mjs', kind: 'plain' },
  ...
  { name: 'sort-rules-routes', file: 'sort-rules-routes.mjs', kind: 'server' },
