  ...
  try {
    ...
    if (kind === 'image' && (ext === '.jpg' || ext === '.jpeg')) {
      ...
      return {
        ...
        capturedAt: normalizeCaptureTime(exif.dateTimeOriginal),
    ...
    if (kind === 'video') {
      ...
      return {
        ...
        capturedAt: normalizeCaptureTime(video.dateTimeOriginal),
    ...
    for (const dirent of entries) {
      ...
      try {
        ...
        db.upsert({
          ...
          capturedAt: meta?.capturedAt ?? null, gpsLat: meta?.gpsLat ?? null, gpsLon: meta?.gpsLon ?? null,
        });
