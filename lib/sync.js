 ...
 */
async function preview({ library, sourceDir, targetDir, targetId, policy, conflictLabel, now = new Date() }) {
...
async function run({
  ...
  const result = await preview({ library, sourceDir, targetDir, targetId, policy, conflictLabel, now });
