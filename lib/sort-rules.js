...
const FIELDS = ['camera.make', 'camera.model', 'kind', 'date'];
 ...
 */
const PLACEHOLDERS = ['year', 'month', 'day', 'camera', 'make', 'model'];
...
function substitute(template, file) {
  ...
  return template.replace(/\{(year|month|day|camera|make|model)\}/g, (_, key) => {
