...
// Every action type Ghost Mode currently proposes — so a Trust screen can
// list all of them (each defaulting to 'ask') even before any proposal of
// that type has ever existed, rather than only showing up once one has.
const KNOWN_ACTION_TYPES = ['trip_cluster', 'camera_correction'];
