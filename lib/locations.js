 ...
 *
 * fs.rmSync on a junction removes the junction, but getting this wrong would
 * delete the album's real contents on the other drive, so it refuses to run
 * on anything that is not a link.
 */
